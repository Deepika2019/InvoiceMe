<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addDebitEntry.aspx.cs" Inherits="addDebitEntry" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Debit Note | Invoice Me</title>
    ...
    <script type="text/javascript">
        ...
        function showWarehouses() {
            ...
            $.ajax({
                type: "POST",
                url: "addDebitEntry.aspx/warehouseName",
        ...
        function selectCustomer(customerId) {
            ...
            $.ajax({
                type: "POST",
                url: "addDebitEntry.aspx/selectCustomerdata",
                ...
                success: function (msg) {
                    ...
                    if (msg.d != "N") {
                        ...
                        console.log(obj[0].balance);

                        if (obj[0].balance == null || obj[0].balance == "") {
                            obj[0].balance = 0;
                        }
                        $("#txtoutstanding").text(obj[0].balance);
                        if (obj[0].balance > 0) {
        ...
        function addDebitEntry() {
            ...
            if (isNaN($("#txtDebitAmt").val())) {
                alert("Debit amount should be in number only...!");
                return false;
            }
            ...
            if ($("#selPaymentType").val() == "1") {
                ...
                cash_amount = parseFloat($("#txtDebitAmt").val());
                chequeamount = 0;
                cheque_bank = 0;
                cheque_number = 0;
                cheque_date = 0;
                ...
                cash_amount = 0;
                chequeamount = parseFloat($("#txtDebitAmt").val());
            ...
            var narration = "" + $("#txtDebitAmt").val() + " given to customer : Note:" + $("#txtspecialnote").val();
            var postObj = {
            ...
            $.ajax({
                type: "POST",
                url: "addDebitEntry.aspx/insertWalletHistory",
                ...
                <div class="nav_menu">
                    <nav>
                        ...
                        <div class="navbar-header" style="width: 100%; display: flex; align-items: center">
                            ...
                            <label style="font-weight: bold; font-size: 16px;">Debit Note</label>
                                ...
                                <form id="Form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                            Debit Amount <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="txtDebitAmt" required="required" class="form-control col-md-7 col-xs-12" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                    ...
                                    <div class="col-md-1 col-sm-12 col-xs-12">
                                        <button type="button" class="btn btn-primary mybtnstyl" onclick="addDebitEntry();">
                                            Save
                                        </button>
                                    </div>
