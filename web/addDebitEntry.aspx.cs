...
public partial class addDebitEntry : System.Web.UI.Page
{
    ...
    public static string selectCustomerdata(string customerid)
    {
        mySqlConnection db = new mySqlConnection();
        DataTable dt = new DataTable();
        string dataQry = "select cust_name,cust_type,cust_amount as balance,max_creditamt,max_creditperiod,new_custtype,new_creditamt,new_creditperiod from tbl_customer where cust_id='" + customerid + "'";
