...
public partial class reports_DownloaditemITReport : System.Web.UI.Page
{
    ...
    public void DumpExcel(DataTable tbl)
    {
        ...
        servbranchname = splitarray[2].ToString();
        ...
        using (ExcelPackage pck = new ExcelPackage())
        {
            ...
            ExcelWorksheet ws = pck.Workbook.Worksheets.Add("SalesItemReport");
            ...
            //for sales return report
            DataTable summaytitle4 = new DataTable();
            DataColumn column4;
            column4 = new DataColumn();
            column4.ColumnName = "Sales Return Summary Report :" + servbranchname + "  Date Range:(" + servfromdate + " to " + servtodate + ")";
            summaytitle4.Columns.Add(column4);

            DataTable summayTable4 = new DataTable();
            summayTable4.Columns.AddRange(new DataColumn[1] { new DataColumn("Total Net Amount", typeof(string)) });
            summayTable4.Rows.Add(servnetamount);
            ...
            string newFileName = "SalesReturnReport";
