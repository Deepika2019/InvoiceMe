...
public partial class sales_normalBillreceipt : System.Web.UI.Page
{
    ...
    public static string showBillReceipt(string billno)
    {
        ...
        try
        {
            ...
            String orderQry = "SELECT cu.cust_id, sm.sm_id,sm.sm_refno, cu.cust_name,concat(ud.first_name,' ',ud.last_name) as staff_name,cu.cust_address as address,cu.cust_city as city,cu.cust_country as country,cust_reg_id as gst,cu.cust_state as state,cu.cust_phone as phone,cu.cust_email as email "
            ...
            String qryItems = "SELECT tsi.itm_code,tsi.itm_name,si_qty as qty,si_price as price "
                + " ,si_total,si_discount_rate as dis_rate,si_discount_amount as dis_amount"
                + " ,si_tax_excluded_total as taxableValue,si_net_amount as net_amount,tp_tax_code,si_item_cgst as cgst,si_item_sgst as sgst,si_item_igst as igst,si_tax_amount "
