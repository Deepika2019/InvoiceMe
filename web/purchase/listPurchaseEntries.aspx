<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listPurchaseEntries.aspx.cs" Inherits="purchase_listPurchaseEntries" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function searchEntries(page) {
            ...
            $.ajax({
                type: "POST",
                url: "listPurchaseEntries.aspx/searchEntries",
                ...
                success: function (msg) {
                    ...
                    $.each(obj.data, function (i, row) {
                        ...
                        htm += '<tr>';
                        htm += '<td>';
                        htm += '<div style="width:400px;">';
                        htm += '<div>';
                        htm += '<div class="fl">';
                        htm += '<span class="myorderMData fl">';
                        htm += '<a class="fl" style="color: inherit; margin-bottom:0px;" href="managepurchase.aspx?purchaseId=' + row.pm_id + '">#' + getHighlightedValue(filters.search, row.pm_invoice_no.toString()) + '</a>';
                        htm += '<label class="fl" style="margin-bottom:0px; padding-left:5px; padding-right:5px; font-size:14px;"><a>' + getHighlightedValue(filters.search, row.vendor_name) + '</a></label>';

                        if (row.pm_total_balance > 0) {
                            htm += '<span class="label label-danger" style="margin-left:2px;">Outstanding</span>';
                        }
                        if (row.pm_status == 1) {
                            htm += '<span class="label label-success" style="margin-left:2px;">Complete</span>';
                        } else {
                            htm += '<span class="label label-default" style="margin-left:2px;">Canceled</span>';
                        }
                        htm += '</div>';
                        htm += '</div>';
                        htm += '<div class="clear"></div>';
                        htm += '<div style="text-align: left;">';
                        htm += '<span class="myorderSData"></span><span class="fa fa-calendar myicons" ></span><span class="myorderSData">' + row.purchaseDate + '</span>&nbsp;&nbsp;<span class="fa fa-edit myicons"></span>';
                        htm += '<span class="myorderSData">' + row.user_name + '</span></div>';
                        htm += '</div>';
                        htm += '</td>';
                        htm += '<td style="text-align:center";>' + row.net_amount + '</td>';
                        htm += '<td style="text-align:center">' + row.pm_total_balance + '</td>';
                        htm += '<td>';
                        htm += '<a href="managepurchase.aspx?purchaseId=' + row.pm_id + '" class="btn btn-primary btn-xs" title="view">';
                        htm += '<li class="fa fa-eye" style="font-size:large;"></li>';
                        htm += '</a>';
                        //htm += '<a href="billreceipt.aspx?orderId=' + row.ref_id + '" class="btn btn-primary btn-xs">';
                    ...
                    <div class="nav_menu">
                        <nav>
                            ...
                            <div class="navbar-header" style="width: 100%; display: flex; align-items: center">
                                ...
                                <label style="font-weight: bold; font-size: 16px;">Purchases</label>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left input_mask">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input type="text" class="form-control has-feedback-left" id="txtSearch" placeholder="Entry Id/Invoice no./Vendor name" />
                                ...
                                <div class="x_panel">
                                    <div class="x_title" style="margin-bottom: 0px;">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <label>Purchases</label><span class="badge" style="color: #fff; margin-left: 5px; background: #d00101; padding-left: 5px; padding-right: 5px;" id="txttotalordercount">0</span>
